 ...
 *
 * @convention for all elements in this, ttl > 0
 * @correspondence this = sequence of unexpired (element, ttl) pairs, ttl > 0
 *
...
public interface PhantomQueue<T> extends PhantomQueueKernel<T> {
    ...
    /**
     * Returns a string reprsentation of the unexpired elements in this queue,
     * in order from oldest to newest.
     *
     * @return string representation of the queue elements
     * @ensures getQueue = "<e1, e2, ...>"
     */
    String getQueue();
}
